...
from chatrnd.chat_env import ChatEnv
from chatrnd.statistics import get_info
from chatrnd.utils import log_visualize, log_arguments
...
class Theory(Phase):
    ...
    def update_chat_env(self, chat_env) -> ChatEnv:
        chat_env._update_theories(self.seminar_conclusion)
        chat_env.rewrite_theories()
        return chat_env